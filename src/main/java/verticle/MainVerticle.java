...
public class MainVerticle extends AbstractVerticle {
    ...
    private void configureConfigRetriever() {
    ...
    private void listen() {
        ...
        future.setHandler(jsonObjectAsyncResult -> {
            if(jsonObjectAsyncResult.failed()) {
                ...
                JsonObject configurations = jsonObjectAsyncResult.result();
                httpServer.listen(configurations.getInteger("server.port")); // port value read from configuration file
            }
        });
//        JsonObject last = configRetriever.getCachedConfig(); get last retrieved configuration without "waiting" to be retrieved
